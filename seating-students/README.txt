Seating Students - Array Challenge - Medium 

Have the function ArrayChallenge(arr) read the array of integers stored in arr which will be in the 
...
Based on above arrangement of occupied desks, there are a total of 6 ways ([1,3][3,4][3,5][8,10][9,10][10,12]) to seat 2 new students next to each other.
